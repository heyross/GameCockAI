"""
N-CEN (Form N-CEN) Processor Module

This module handles processing of N-CEN filing data from ZIP archives.
N-CEN is the annual report for registered investment companies.
"""
...
from database import (
    NCENSubmission, NCENRegistrant, NCENFundReportedInfo, 
...
logger = get_processor_logger('processor_ncen')
    ...
    for zip_file in zip_files:
        ...
        try:
            ...
            logger.error(f"Error processing N-CEN file {zip_file}: {str(e)}")
            results["errors"] += 1
